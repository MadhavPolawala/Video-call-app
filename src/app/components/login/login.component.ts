      ...
      <div class="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        ...
        <form (ngSubmit)="joinCall()" class="space-y-6">
          ...
          <button
            ...
            class="w-full bg-blue-500 hover:bg-blue-600 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 disabled:scale-100"
          >
            Join Video Call
          </button>
        </form>
